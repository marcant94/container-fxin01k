...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fxin01k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fxin01k.containers.anotherwebservice.com/
...
```
git clone git@github.com:marcant94/container-fxin01k.git
cd container-fxin01k
```
...
```
docker attach container-fxin01k
```
